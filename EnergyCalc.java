...
//		System.out.println("wall clock time per loop: " + wallClockTimePerLoop[loopCount] + "curWallClockTime: " + curWallClockTime);
		...
		for(int i = 0; i < sockNum; i++) {
			delta = calculateEnergy(Double.parseDouble(loopEnergyStop[i][0].replace(",", ".")), Double.parseDouble(loopEnergyStart[i][0].replace(",", ".")));
			...
			delta = calculateEnergy(Double.parseDouble(loopEnergyStop[i][1].replace(",", ".")), Double.parseDouble(loopEnergyStart[i][1].replace(",", ".")));
			//record for standard deviation
			...
			delta = calculateEnergy(Double.parseDouble(loopEnergyStop[i][2].replace(",", ".")), Double.parseDouble(loopEnergyStart[i][2].replace(",", ".")));
			//record for standard deviation
